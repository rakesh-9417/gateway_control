...
add_hook('ClientAreaPage', 99999, function ($vars) {
    if ($vars['filename'] === 'viewinvoice' && isset($_GET['id'])) {
        ...
        if ($storedRenewalRestrict) {
            ...
            // $isRenewal__ = !empty($relatedIds) && Capsule::table('tblhosting')
            ...
            if ($isRenewal) {
                ...
                return $vars; // For non-Lagom themes, just remove the gateway from availableGateways
            }
        }
    }
...
add_hook('ClientAreaPageViewInvoice', 1, function($vars) {
    return [
        'myCustomVariable' => 'Custom Value Here'
    ];
});
